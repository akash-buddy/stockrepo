...
if option=="Nifty 100":
    ...
    filen="Only_nse_agriculture.csv"
...
if butto:
    ...
    with st.spinner('Wait for few seconds.....'):
        ...
        for i in sl:
            ...
            ema1 = result2[i].ewm(span=moving_window1+50, adjust=False).mean()
            ema1
